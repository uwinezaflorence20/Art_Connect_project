  ...
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl px-2 py-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-2 rounded-lg bg-orange-500 p-6 shadow-lg sm:flex-row sm:justify-between">
        ...
        <div className="mt-8">
          <div className=" sm:flex sm:items-center sm:justify-between">
            <div className="flex justify-center text-orange-500 sm:justify-start">
            ...
            <div>
              <p className="mt-4  flex justify-center text-center text-sm text-gray-500 sm:mt-0 sm:text-right">
              ...
              <ul className="flex justify-center gap-6 sm:justify-end">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-orange-500 transition hover:text-orange-100"
                  >
